//Take inputs from external file and dump output to external file
...
import java.io.*;
 ...
 class mergeArrays1 {  
	...
	{  	File file = new File("userInputs.txt");
		Scanner sc = new Scanner(file);
		int n1,n2;
		System.out.println("Enter the number of elements in firstArray: (read from file)");
		n1=sc.nextInt();
		int[] firstArray = new int[n1];  
		System.out.println("Enter the number of elements in secondArray: (read from file) ");
		n2=sc.nextInt();
		int[] secondArray = new int[n2];  
		System.out.println("Enter "+n1+" integer elements in First Array: (read from file) ");
		for(int i=0;i<n1;i++)
		{
			firstArray[i]=sc.nextInt();
		}
		System.out.println("Enter "+n2+" integer elements in First Array: (read from file) ");
		for(int i=0;i<n2;i++)
		{
