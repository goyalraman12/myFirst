// Dump output to file and dump input to new file having name as time of execution
...
import java.util.Date;  
 ...
 class dumpOutputToFile1 {  
	public static void main(String[] args)  throws FileNotFoundException 
	{
		SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy_HH-mm-ss");  
		Date date = new Date();  
		String date_String = "inp_"+formatter.format(date)+".txt";
		PrintStream inp = new PrintStream(new File(date_String));
